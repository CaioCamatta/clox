...
/* Check if current char matches expected char. If so, advance.*/
...
static TokenType checkKeyword(int start, int length,
    ...
    // The keyword needs exactly the righ number of character and the characters must be correct
...
Token scanToken() {
    ...
    char c = advance();
    if (isAlpha(c)) return identifier();  // After first letter, allow numbers too.
